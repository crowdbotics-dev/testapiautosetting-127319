...
## Project Structure
    ...
    ├── testapiautosetting_127319  # Django project configurations
...
1. Clone this repo and `cd testapiautosetting_127319`
...
2. Clone this repo and `cd testapiautosetting_127319`
